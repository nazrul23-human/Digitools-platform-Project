      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold tracking-tighter text-white">
                <img className='pr-15' src="" alt="" />
              </h2>
            </div>

            <p className="text-zinc-500 text-lg max-w-md ">
              Premium digital tools for <br></br> 
              creators, professionals,<br></br> and businesses.<br></br> Work smarter with our suite of<br></br> powerful tools.
            </p>
          ...
          <div className="md:col-span-3">
            <h3 className="text-red-400 font-semibold mb-6 text-lg flex">Legal</h3>
            <ul className="space-y-4 text-zinc-400">
              <li>
                <a href="#" className="hover:text-white transition">
                  Privacy Policy
